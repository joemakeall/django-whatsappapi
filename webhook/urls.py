...
urlpatterns = [
    ...
    path('products_list_detail/',                views.products_list_detail,  name='products_list_detail'),
    path('products_group_detail/',               views.products_group_detail, name='products_group_detail'),
